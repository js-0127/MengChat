...
<template>
    <div class="mt-8 space-y-6">
        ...
        <div class="relative">
            ...
            <input class="login-form-input" type="" placeholder="请输入账号" v-model="registerForm.username" />
        </div>
        <div class="mt-8 content-center">
            <label class="login-form-label">密码</label>
            <input class="login-form-input" type="password" placeholder="请输入密码" v-model="registerForm.password" />
        </div>

        <div class="mt-8 content-center">
            <label class="login-form-label">确认密码</label>
            <input class="login-form-input" type="password" placeholder="请确认密码"
                v-model="registerForm.password_isConfirmed" />
        </div>
        <div class="mt-8 content-center">
            <label class="login-form-label">验证码</label>
            <div class="flex w-full h-ful items-center">
                <input class="login-form-input" type="" placeholder="请输入验证码" v-model="registerForm.text" />
        ...
        <p class="items-centerjustify-centermt-10 text-center text-md text-gray-500">
            <span>已有账号？</span>
            <a href="javascript:;" @click="changeStatus(authStatus.login, 'login')"
